...
#### Comment: The visualization is easy to understand and read by descending order. I would suggest to stretch them out a bit more, so the labels aren't so smashed together. It may also good to rename the legend label and legend title so the plot looks more delicate.
